...
const items = [
    { icon: 'fab fa-youtube', link: 'https://youtube.com/@XQTRTR' },
    { icon: 'fab fa-twitch', link: 'https://twitch.com/XQTRCK' },
    { icon: 'fab fa-discord', link: 'https://discord.com/users/793527442022727690' },
  ]
